        ...
        with open("coding_test_output.html", "w", encoding="utf-8") as f:
            ...
            f.write(f"""
                   ...
                   <div>
                        ...
                        <img src="./beeswarm_plot.png" alt="SHAP Beeswarm Plot" style="width:50%; height:auto; display:block; margin:auto;">
                    </div>
                    <hr style="width:80%"/>
                    <div>
                        <h2 style="text-align:center;">SHAP Decision Plot</h2>
                        <img src="./decision_plot.png" alt="SHAP Decision Plot" style="width:50%; height:auto; display:block; margin:auto;">
                    </div>
                    <hr style="width:80%"/>
                    <div>
                        <h2 style="text-align:center;">SHAP Summary Bar Plot</h2>
                        <img src="./summary_bar_plot.png" alt="SHAP Summary Bar Plot" style="width:50%; height:auto; display:block; margin:auto;">
                    </div>
                </body>
            </html>
            """)
